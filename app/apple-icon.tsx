...
/**
 * apple-icon — 180×180 PNG generated at the edge, picked up
 * automatically by Next App Router and emitted as
 * `<link rel="apple-touch-icon" />` in the head.
 *
 * Renders the white frangipani mark on the brand ink background so the
 * homescreen icon matches the rest of the visual system.
 */
...
export default async function AppleIcon() {
  return new ImageResponse(
    (
      ...
      >
        <svg width="116" height="110" viewBox="0 0 232.34 220.98">
          <g fill="#FFFFFF">
            {PETAL_PATHS.map((d, i) => (
              <path key={i} d={d} />
            ))}
