...
<Diagram
  label="A Venn diagram of three overlapping circles labelled Containment, CSAT and Recontact. Where all three overlap is the only zone that represents real automation quality. The non-overlapping zones are labelled with the failure modes a single-metric read leaves you in."
  caption="The automation quality triangle as a Venn. A high containment number alone can sit in any of three different failure zones — the only safe read is where all three overlap."
  tone="sky"
>
  <svg viewBox="0 0 720 520" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    <style>{`
      ...
      .circle-h { font: 600 18px Inter, system-ui, sans-serif; fill: #171717; letter-spacing: -0.01em; }
      .circle-q { font: 400 12px Inter, system-ui, sans-serif; fill: #404040; font-style: italic; }
      .zone-lbl { font: 600 10px 'JetBrains Mono', ui-monospace, monospace; letter-spacing: 0.2em; }
      .zone-fail { font: 600 12px Inter, system-ui, sans-serif; }
      .centre-tag { font: 600 11px 'JetBrains Mono', ui-monospace, monospace; fill: #2C5340; letter-spacing: 0.22em; }
      .centre-h { font: 600 14px Inter, system-ui, sans-serif; fill: #2C5340; letter-spacing: -0.01em; }
    `}</style>

    {/* Header */}
    <text x="40" y="32" className="eyebrow">THE QUALITY TRIANGLE · READ TOGETHER, NEVER ALONE</text>
    <line x1="40" y1="46" x2="680" y2="46" stroke="#E5E5E5" />

    {/* Three overlapping circles — translucent fills */}
    <circle cx="360" cy="180" r="130" fill="#DDE7EF" opacity="0.55" />
    <circle cx="280" cy="320" r="130" fill="#F0E5D5" opacity="0.55" />
    <circle cx="440" cy="320" r="130" fill="#EFDDE0" opacity="0.55" />

    {/* Circle labels */}
    <text x="360" y="84" textAnchor="middle" className="circle-h">Containment</text>
    <text x="360" y="102" textAnchor="middle" className="circle-q">Did the AI handle it?</text>

    <text x="150" y="360" textAnchor="middle" className="circle-h">CSAT</text>
    <text x="150" y="378" textAnchor="middle" className="circle-q">Did satisfaction hold?</text>

    <text x="572" y="360" textAnchor="middle" className="circle-h">Recontact</text>
    <text x="572" y="378" textAnchor="middle" className="circle-q">Did they come back?</text>

    {/* Failure-mode labels in single-metric zones */}
    {/* Top only — high containment alone */}
    <text x="360" y="155" textAnchor="middle" className="zone-lbl" style={{ fill: "#1F4060" }}>HIGH CONTAINMENT ONLY</text>
    <text x="360" y="174" textAnchor="middle" className="zone-fail" style={{ fill: "#1F4060" }}>could be a wall</text>

    {/* Bottom-left only — CSAT alone */}
    <text x="208" y="338" textAnchor="middle" className="zone-lbl" style={{ fill: "#5C4830" }}>CSAT ONLY</text>
    <text x="208" y="356" textAnchor="middle" className="zone-fail" style={{ fill: "#5C4830" }}>polite but unhelpful</text>

    {/* Bottom-right only — Recontact alone */}
    <text x="510" y="338" textAnchor="middle" className="zone-lbl" style={{ fill: "#8A4A47" }}>RECONTACT ONLY</text>
    <text x="510" y="356" textAnchor="middle" className="zone-fail" style={{ fill: "#8A4A47" }}>can't tell why</text>

    {/* Centre — all three overlap */}
    <ellipse cx="360" cy="260" rx="80" ry="60" fill="#171717" />
    <text x="360" y="252" textAnchor="middle" className="centre-tag" style={{ fill: "#DFEADF" }}>ALL THREE</text>
    <text x="360" y="272" textAnchor="middle" className="centre-h" style={{ fill: "#FFFFFF" }}>real resolution</text>
    <text x="360" y="290" textAnchor="middle" className="circle-q" style={{ fill: "#FFFFFF", opacity: 0.7 }}>the only safe read</text>

    {/* Footnote */}
    <line x1="40" y1="478" x2="680" y2="478" stroke="#E5E5E5" />
    <text x="40" y="500" className="circle-q">Any containment figure shown without CSAT and recontact is half a picture, and usually the flattering half.</text>
  </svg>
</Diagram>
